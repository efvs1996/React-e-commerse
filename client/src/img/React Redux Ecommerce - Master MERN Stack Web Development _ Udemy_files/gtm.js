...
var ne=[],oe={"\x00":"&#0;",'"':"&quot;","&":"&amp;","'":"&#39;","<":"&lt;",">":"&gt;","\t":"&#9;","\n":"&#10;","\x0B":"&#11;","\f":"&#12;","\r":"&#13;"," ":"&#32;","-":"&#45;","/":"&#47;","=":"&#61;","`":"&#96;","\u0085":"&#133;","\u00a0":"&#160;","\u2028":"&#8232;","\u2029":"&#8233;"},pe=function(a){return oe[a]},qe=/[\x00\x22\x26\x27\x3c\x3e]/g;ne[3]=function(a){return String(a).replace(qe,pe)};var ue=/[\x00\x08-\x0d\x22\x26\x27\/\x3c-\x3e\\\x85\u2028\u2029]/g,ve={"\x00":"\\x00","\b":"\\x08","\t":"\\t","\n":"\\n","\x0B":"\\x0b",
...
var Xg=[N.D,N.I],Yg=function(a){var b=a[N.Hd];b&&zg(40);var c=a[N.nf];c&&zg(41);for(var d=La(b)?b:[b],e={Pb:0};e.Pb<d.length;e={Pb:e.Pb},++e.Pb)Va(a,function(f){return function(g,h){if(g!==N.Hd&&g!==N.nf){var l=d[f.Pb];Hg().set(g,h,l,"CR","CR-A",c)}}}(e))},Zg=function(a,b){Va(a,function(c,d){Hg().update(c,d)});Tg(b)},fh=function(a){var b=Ng(a);return void 0!=b?b:!0},gh=function(){return"G1"+Wg(Ng)},hh=function(a,b){Sg(a,b)},ih=function(a,b){Vg(a,b)},jh=function(a,b){Ug(a,
...
Y.h.ga=["google"],function(){var a,b;(function(c){Y.__ga=c;Y.__ga.m="ga";Y.__ga.o=!0;Y.__ga.priorityOverride=0})(function(c){function d(P){var K=[].slice.call(arguments,0);K[0]=u+K[0];r.push(K)}function e(P,K){void 0!==c[K]&&d(P,c[K])}function f(P,K){void 0!==c[K]&&d(P,Number(c[K]))}function g(P,K){if(q(K))for(var W=0;W<K.length;W++)d(P,K[W])}function h(P,K,W){if(q(K))for(var ca=0;ca<K.length;ca++){for(var O=[P],ka=K[ca],ta=0;ta<
W.length;ta++)O.push(ka[W[ta]]);d.apply(this,O)}}function l(P,K){void 0!==c[K]&&d("_set",P,c[K])}function m(P,K){return void 0===K?K:P(K)}function p(P,K){void 0!==K&&(v+="&"+P+"="+K)}var q=La,r=V("_gaq",[],!1),t=!1,u="";void 0==c.vtp_trackerName?u="gtm"+Ci()+".":""!==c.vtp_trackerName&&(u=c.vtp_trackerName+".");e("_setAccount","vtp_webPropertyId");d("_set","gtmid",In(!0));
e("_setAllowLinker","vtp_allowLinker");
e("_setAllowAnchor","vtp_allowAnchor");e("_setAllowHash","vtp_allowHash");
g("_addIgnoredRef",c.vtp_ignoredRef);g("_addIgnoredOrganic",c.vtp_ignoredOrganic);var v="";if(""!==v){var w=function(P,K,W){for(var ca=K.length-1;0<=ca;ca--){var O=K[ca].split("=");if(O[0]===P)return O[1]||"1"}for(var ka=W.length-1;0<=ka;ka--){var ta=W[ka].split("=");if(ta[0]===P)return ta[1]||"1"}},y=Gh(su()),x=Eh(y,"query").split("&"),z=c.vtp_allowAnchor?Eh(y,"fragment").split("&"):[];p("gclid",w("gclid",z,x));p("gclsrc",w("gclsrc",z,x));p("dclid",w("dclid",z,x));d("_set",
...
t=!!c.vtp_forceSsl);d("_set","hitCallback",function(){Ja(c.vtp_hitCallback)&&c.vtp_hitCallback();c.vtp_gtmOnSuccess()});
if("TRACK_EVENT"==c.vtp_trackType){d("_trackEvent",String(c.vtp_eventCategory),String(c.vtp_eventAction),m(String,c.vtp_eventLabel),m(Xa,c.vtp_eventValue),!!c.vtp_nonInteraction);}else if("TRACK_TRANSACTION"==c.vtp_trackType){}else if("LINK"==c.vtp_trackType){}else if("LINK_BY_POST"==
...
g("_cookiePathCopy",c.vtp_cookiePathCopy);var U=function(){V("_gat")||c.vtp_gtmOnFailure()};if(c.vtp_doubleClick)b||(b=!0,Q(al("https","http","://stats.g.doubleclick.net/dc.js",t),U,c.vtp_gtmOnFailure));else if(!a){var S=c.vtp_useDebugVersion?".google-analytics.com/u/ga_debug.js":".google-analytics.com/ga.js";a=!0;Q(al("https://ssl","http://www",S,t),U,c.vtp_gtmOnFailure)}})}();
